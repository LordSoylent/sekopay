Contributing to Seko Core
============================

The Seko Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Seko Core project, and is not to be
confused with overall Seko Network Protocol consensus changes.

Whether a pull request is merged into Seko Core rests with the project merge
...
Patches that change Seko consensus rules are considerably more involved than
...
Where a patch set proposes to change the Seko consensus, it must have been
...
The project leader is the release manager for each Seko Core release.
