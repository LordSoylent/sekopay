                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Seko from zSeko"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zSeko"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zSeko));
