...
public:
    ...
    void setZSekoControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzSEKO_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzSEKO_clicked();
    void on_pushButtonZSekoControl_clicked();
