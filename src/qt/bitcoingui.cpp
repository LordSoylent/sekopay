                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("SekoPay Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Seko address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and seko: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zSEKO"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About SekoPay Core"), this);
    aboutAction->setStatusTip(tr("Show information about SekoPay Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Seko"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Seko addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Seko addresses"));
    ...
    openAction->setStatusTip(tr("Open a Seko: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the SekoPay Core help message to get a list with possible Seko command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("SekoPay Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Seko network", "", count));
}
...
{
    QString strTitle = tr("SekoPay Core"); // default title
...
/** Creates context menu, its actions, and sekos up all the relevant signals for mouse events. */
