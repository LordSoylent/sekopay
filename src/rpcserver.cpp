...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Seko features */
        {"seko", "masternode", &masternode, true, true, false},
        {"seko", "listmasternodes", &listmasternodes, true, true, false},
        {"seko", "getmasternodecount", &getmasternodecount, true, true, false},
        {"seko", "masternodeconnect", &masternodeconnect, true, true, false},
        {"seko", "masternodecurrent", &masternodecurrent, true, true, false},
        {"seko", "masternodedebug", &masternodedebug, true, true, false},
        {"seko", "startmasternode", &startmasternode, true, true, false},
        {"seko", "createmasternodekey", &createmasternodekey, true, true, false},
        {"seko", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"seko", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"seko", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"seko", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"seko", "getmasternodescores", &getmasternodescores, true, true, false},
        {"seko", "mnbudget", &mnbudget, true, true, false},
        {"seko", "preparebudget", &preparebudget, true, true, false},
        {"seko", "submitbudget", &submitbudget, true, true, false},
        {"seko", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"seko", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"seko", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"seko", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"seko", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"seko", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"seko", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"seko", "checkbudgets", &checkbudgets, true, true, false},
        {"seko", "mnsync", &mnsync, true, true, false},
        {"seko", "spork", &spork, true, true, false},
        {"seko", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"seko", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use sekod, or the -server option to seko-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> seko-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:5786/\n";
}
