...
RESOURCES += src/qt/seko.qrc src/qt/seko_locale.qrc

TRANSLATIONS += src/qt/locale/seko_bg.ts \
                src/qt/locale/seko_de.ts \
                src/qt/locale/seko_en.ts \
                src/qt/locale/seko_es.ts \
                src/qt/locale/seko_fi.ts \
                src/qt/locale/seko_fr.ts \
                src/qt/locale/seko_it.ts \
                src/qt/locale/seko_ja.ts \
                src/qt/locale/seko_pl.ts \
                src/qt/locale/seko_pt.ts \
                src/qt/locale/seko_ru.ts \
                src/qt/locale/seko_sk.ts \
                src/qt/locale/seko_sv.ts \
                src/qt/locale/seko_vi.ts \
                src/qt/locale/seko_zh_CN.ts \
                src/qt/locale/seko_zh_TW.ts
