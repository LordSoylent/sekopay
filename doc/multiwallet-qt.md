...
In order to support loading of multiple wallets in seko-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is seko.cpp.
...
Changes to seko.cpp
----------------------
seko.cpp is the entry point into seko-qt, and as such, will require some minor modifications to provide hooks for
